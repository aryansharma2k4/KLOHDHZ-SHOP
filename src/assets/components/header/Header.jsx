  ...
  return (
   ...
   <div className={`fixed top-0 left-0 right-0 z-10 py-3 flex justify-between items-center ${isActive ? 'bg-white shadow-md' : ''}`}>
    ...
    <div className='flex'>
        ...
        <button className='mr-4 bg-black text-mono font-semibold border-black b0rder-2 shadow-lg text-white px-2 rounded-xl hover:bg-white hover:text-black duration-200 linear'>LOGIN</button>
        <button className='mr-4 bg-black text-mono font-semibold border-black b0rder-2 shadow-lg text-white px-2 rounded-xl hover:bg-white hover:text-black duration-200 linear'>CONTACT</button>
    </div>
   </div>
   </>
  );
