...
function Header() {
  ...
  return (
   <>
   <div className={`${isActive ? 'bg-white shadow-md ' : ''} fixed transform duration-100 w-full flex justify-between py-3 items-center`}>
    <div className='flex'>
        <div className='mr-3'>
